...
#(
  ...
  logic issue_valid, issue_ready, decoder_issue_ready, issue_fire;
  ...
  instr_decoder #(
      ...
      .issue_ready_o   (decoder_issue_ready),
  ...
  assign issue_ready = decoder_issue_ready && ~alu_busy;
